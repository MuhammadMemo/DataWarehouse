...
MeansOfDeliveryKey tinyint NOT NULL,
PaymentMethodsKey bigINT NOT NULL,
...
LastupdateDate datetime DEFAULT getDate()
    ...
    CONSTRAINT [PF_MeansOfDating] FOREIGN KEY  (MeansOfDatingKey,CompanyKey) REFERENCES DimMeansOfDating(MeansOfDatingKey,CompanyKey),
    CONSTRAINT [PF_MeansOfDelivery] FOREIGN KEY  (MeansOfDeliveryKey,CompanyKey) REFERENCES DimMeansOfDelivery(MeansOfDeliveryKey,CompanyKey),
    CONSTRAINT [PF_PaymentMethods] FOREIGN KEY  (PaymentMethodsKey,CompanyKey) REFERENCES DimPaymentMethods(PaymentMethodsKey,CompanyKey),
    CONSTRAINT [PF_TermsOfDeliveryKey] FOREIGN KEY  (TermsOfDeliveryKey,CompanyKey) REFERENCES DimTermsOfDelivery(TermsOfDeliveryKey,CompanyKey),
