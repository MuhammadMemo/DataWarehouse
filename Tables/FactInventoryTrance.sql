...
--Foreign Keys :
 ...
 CONSTRAINT [PK_FactInventory] PRIMARY KEY (CompanyKey,InventTranceKey,DimensionKey,ID) NOT NULL,
    ...
    CONSTRAINT [PF_InvStatusIssue] FOREIGN KEY (StatusIssueKey) REFERENCES DimFixInventStatusIssue(StatusIssueKey),
	CONSTRAINT [PF_InvStatusReceipt] FOREIGN KEY (StatusReceiptKey) REFERENCES DimFixInventStatusReceipt(StatusReceiptKey),
	CONSTRAINT [PF_InvTransType] FOREIGN KEY (TransTypeKey) REFERENCES DimFixInventTransType(TransTypeKey),
