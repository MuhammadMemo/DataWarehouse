...
--Foreign Keys :
 ...
 CONSTRAINT [PK_FactInventory] PRIMARY KEY (CompanyKey,InventTranceKey,DimensionKey,ID) NOT NULL,
    ...
    CONSTRAINT [PF_InvStatusIssue] FOREIGN KEY (StatusIssueKey) REFERENCES DimInventStatusIssue(StatusIssueKey),
	CONSTRAINT [PF_InvStatusReceipt] FOREIGN KEY (StatusReceiptKey) REFERENCES DimInventStatusReceipt(StatusReceiptKey),
