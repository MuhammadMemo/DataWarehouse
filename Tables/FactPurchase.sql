...
LastupdateDate datetime DEFAULT getDate()
    ...
    CONSTRAINT [PF_PurhStatus] FOREIGN KEY (StatusKey) REFERENCES DimOrderStatus(StatusKey),
    CONSTRAINT [PF_PurhType] FOREIGN KEY (TypeKey) REFERENCES DimPurchaseType(TypeKey),
