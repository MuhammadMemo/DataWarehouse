...
LastupdateDate datetime DEFAULT getDate()
    ...
    CONSTRAINT [PF_PurhStatus] FOREIGN KEY (StatusKey) REFERENCES DimSalesStatus(StatusKey),
    CONSTRAINT [PF_PurhType] FOREIGN KEY (TypeKey) REFERENCES DimSalesType(TypeKey),
